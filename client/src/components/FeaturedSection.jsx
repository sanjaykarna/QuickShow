      ...
      <div className="relative flex items-center justify-between pt-20 pb-10">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="w-16 h-0.5 bg-gradient-to-r from-red-400 to-transparent mt-1" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-12 mt-8">
          {[...Array(4)].map((_, i) => (
            <div key={i} className="animate-pulse">
              <div className="bg-gray-700/50 rounded-lg h-96 mb-4" />
              <div className="bg-gray-700/50 rounded h-4 mb-2" />
              <div className="bg-gray-700/50 rounded h-3 w-3/4" />
            </div>
          ))}
        </div>
      )}
