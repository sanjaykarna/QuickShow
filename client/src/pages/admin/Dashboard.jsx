  ...
  return !loading ?(
    ...
    <div className='relative flex flex-wrap gap-6 mt-4 max-w-5xl'>
        ...
        {dashboardData.activeShows.map((show)=>(
            <div key={show._id} className='w-52 rounded-lg overflow-hidden h-full pb-3 bg-red-400/10 border border-red-400/20 hover:translate-y-1 transition duration-300'>
